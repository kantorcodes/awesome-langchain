...
- [LangChain Registry Broker](https://github.com/hashgraph-online/langchain-registry-broker): LangChain tools for AI agent discovery across 59,000+ agents from NANDA, MCP, OpenRouter, A2A, Virtuals, and more. Search, resolve, and discover agents using natural language. ![GitHub Repo stars](https://img.shields.io/github/stars/hashgraph-online/langchain-registry-broker?style=social)
